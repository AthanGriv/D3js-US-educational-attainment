...
var donut = donutChart()
    ...
    d3.tsv('assets/data/All/Education/ACSST5Y2016_S1401_with_ann_2018-01-24T215322EST_EDITED.csv', function(error, data) {
...
function donutChart() {
    var width,
        ...
        colour = d3.scaleOrdinal().range(["#59ce23", "#832c89", "#1702fc", "#601f29", "#e2cc1f", "#54fff3", "#ddceed"]), // colour scheme
